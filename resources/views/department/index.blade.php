                ...
                <div class="c-table-responsive@desktop"> 
                    <table class="c-table">
                        ...
                        <tbody>
                            ...
                            <td class="c-table__cell">{{$data->department_name}}</td>   
                            ...
                            <div class="c-dropdown dropdown">
                                    ...
                                    <div class="c-dropdown__menu dropdown-menu" aria-labelledby="dropdownMenuButton21" x-placement="top-start" style="position: absolute; transform: translate3d(0px, -155px, 0px); top: 0px; left: 0px; will-change: transform;">
                                        <a class="c-dropdown__item dropdown-item" href="{{URL::route('department.update_form',$data->id)}}">Update</a>  
                                        <a class="c-dropdown__item dropdown-item" href="{{URL::route('department.delete',$data->id)}}" onclick="return confirm('Are you sure?')">Delete</a>  
                                    </div>
                                </div>
                            </td>
                            @endforeach  
